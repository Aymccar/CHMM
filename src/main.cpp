...
int main(int argc, char** argv){
    ...
    //HMM 1 (3 states)
    State air("air", [](const vector<double>& O_t){
            cout << "called" << endl; return 1;},     
            {{"air", 0.33}, {"earth", 0.33}, {"see", 0.33}});

    State earth("earth", [](const vector<double>& O_t){return 1;}, {{"air", 0.33}, {"earth", 0.33}, {"see", 0.33}});
    State see("see", [](const vector<double>& O_t){return 1;},     {{"air", 0.33}, {"earth", 0.33}, {"see", 0.33}});
